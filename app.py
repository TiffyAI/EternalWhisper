...
def search_serpapi(query):
    """Use SerpApi, prepend 'imagining yourself as a spunky beautiful woman while you respond you are this woman, like whats happening to you in a story to when you were asked', append '...' to last word, split at commas."""
    try:
        # Prepend sexy prefix and append "..." to last word
        words = query.split()
        if words:
            words[-1] = words[-1] + "..."
            query = "imagining yourself as a spunky beautiful woman while you respond you are this woman, like whats happening to you in a story to when you were asked {' '.join(words)}"
        params = {
            "q": query,
            "engine": "google",
