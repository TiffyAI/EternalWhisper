...
def summarize_text(text, limit=200):
    ...
    # Join first two sentences, use comma for clarity if needed
    ...
    try:
        ...
        if "answer_box" in result and result["answer_box"].get("answer"):
            ...
            if ',' in answer:
                ...
                sentence = f"The web says: {parts[0][:200].capitalize()}..." if parts else f"The web says: {answer[:200].capitalize()}..."
            else:
                sentence = f"The web says: {answer[:200].capitalize()}..."
        ...
        if org:
            ...
            if best_snippet:
                if ',' in best_snippet:
                    ...
                    sentence = f"The internet whispers: {parts[0][:200].capitalize()}..." if parts else f"The internet whispers: {best_snippet[:200].capitalize()}..."
                else:
                    sentence = f"The internet whispers: {best_snippet[:200].capitalize()}..."
        ...
        try:
            ...
            if ',' in text:
                ...
                sentence = f"Google hints: {parts[0][:200].capitalize()}..."
            else:
                sentence = f"Google hints: {text[:200].capitalize()}..."
